...
namespace SampWebApi.Controllers
{
    ...
    public class InvoiceController : ApiController
    {
        ...
        public IHttpActionResult GetgetproductlistData(string TransID, string Branch, string PriceType, string Date)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("Invoice", "invoice/getproductlist", ex.Message);
            }
            return Ok();
        }
        [HttpGet]
        ...
        .ToList();
            ...
            {
                bl.BL_WriteErrorMsginLog("Invoice", "invoice/getcustomerlist", ex.Message);
            }
            return Ok();
        }
            [HttpGet]
        ...
        public IHttpActionResult getDiscountschemeinfo(string CustomerID, string Date)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("Invoice", "invoice/discountschemeinfo", ex.Message);
            }
            return Ok();
        }
        [HttpGet]
        ...
        public IHttpActionResult GetFilterData(string TransID, string FType, string Branch, string Party, string FromDate, string ToDate, string Showall)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("Invoice", "invoice/getfilterdata", ex.Message);
            }
            return Ok();
        }
        [HttpGet]
        ...
        public IHttpActionResult validatecreditlim(string CustID, string Date, string CreditTermID, string NetAmt, string TransID)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("Invoice", "invoice/validatecreditlimit", ex.Message);
            }
            return Ok();
        }
        [HttpGet]
        ...
        public IHttpActionResult invoicecollectiondata(string InvoiceID,string TransID)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("Invoice", "invoice/invoicecollectiondata", ex.Message);
            }
            return Ok();
        }
        [HttpPost]
        ...
        public IHttpActionResult checkPASSOWRD(ApplicationConfig lstPWD)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("Invoice", "invoice/verifycreditlimit", ex.Message);
            }
            return Ok();
        }
        [HttpPost]
            ...
            string Copies="1",string Branch = "0", string FromDate = null, string ToDate = null)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("Invoice", "transactionprint/generateprint", ex.Message);
            }
            return Ok();
        }
        ...
        public HttpResponseMessage downloadprintData(string FName)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("Invoice", "invoice/downloadprint", ex.Message);
            }
