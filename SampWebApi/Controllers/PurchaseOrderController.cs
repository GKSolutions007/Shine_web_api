...
namespace SampWebApi.Controllers
{
    ...
    public class PurchaseOrderController : ApiController
    {
        ...
        public IHttpActionResult GetData(string Mode, string CodeName, string ID = null)
        {
                            ...
                            for (int k = 0; k < DDT2.Rows.Count; k++)
                            {
                              ...
                              //.Sum();
                                ...
                                listProductGrid.Add(new PurchaseGridData
                                {
                                    ...
                                    MRPonTax = DDT2.Rows[k]["CumulativeTax"].ToString(),//dApponMRPCum.ToString(),
            ...
            {
                bl.BL_WriteErrorMsginLog("PurchaseOrder", "purchaseorder/get", ex.Message);
            }
            return Ok();
        }
        [HttpGet]
        ...
        public IHttpActionResult GetFilterData(string ProdID, string BranchID)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("PurchaseOrder", "purchaseorder/productqtybatch", ex.Message);
            }
            return Ok();
        }
        [HttpGet]
        ...
        public IHttpActionResult GetFilterData(string TransID, string FType, string Branch, string Party, string FromDate, string ToDate, string Showall)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("PurchaseOrder", "purchaseorder/getfilterdata", ex.Message);
            }
            return Ok();
        }
        [HttpGet]
        ...
        public IHttpActionResult GetManufItems(string PartyID, string ManufID, string DaysAvg, string BaseorPurchase)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("PurchaseOrder", "purchaseorder/manufitems", ex.Message);
            }
            return Ok();
        }
            [HttpPost]
        ...
        public IHttpActionResult Save(PurchaseModel listTrans)
        {
            ...
            {
                bl.BL_WriteErrorMsginLog("PurchaseOrder", "purchaseorder/save", ex.Message);
            }
